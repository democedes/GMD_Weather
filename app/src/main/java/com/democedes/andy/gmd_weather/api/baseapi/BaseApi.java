package com.democedes.andy.gmd_weather.api.baseapi;

import com.democedes.andy.gmd_weather.api.ExcludedFromAPISerialization;
...
public abstract class BaseApi<T> {
    ...
    private void initializeHttpCache(long dirSize) {
        ...
        File cacheDirectory = new File(GMDWeather.getApplication().getCacheDir(), cacheDirectoryName);
